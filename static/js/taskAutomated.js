...
var TestPhase = function() {
    ...
    var maxTrial = 200; // Number of trials
...
//		        console.log('0mu: ', data[0]['card1']['mu'], data[0]['card2']['mu'], data[0]['card3']['mu'], data[0]['card4']['mu']);
                ...
                // Save data to psiTurk object (via an array). After wait due to timestamp
                    ...
                    for (var y = 1; y <= 4; y++) {
                        ...
                        trialSet.push(data[trial]['card' + y]['fullR'].toFixed(4)); // Recording unrounded R as error term added to mu
                        //trialSet.push('Card ' + y + ' mu:');
                        trialSet.push(data[trial]['card' + y]['mu'].toFixed(4));
                    }
